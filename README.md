...
- [ ] **Phase 1: 基础设施** — 完成真实地图解析与静态车辆投放测试。
  - [#17 Phase 1.1: OSM 数据导入管线设计](https://github.com/kcccn/sharedBikes/issues/17)
  - [#18 Phase 1.2: Node/Edge 路网解析器](https://github.com/kcccn/sharedBikes/issues/18)
  - [#19 Phase 1.3: Station 自动生成算法](https://github.com/kcccn/sharedBikes/issues/19)
  - [#20 Phase 1.4: 静态车辆投放与基础模拟测试](https://github.com/kcccn/sharedBikes/issues/20)
